"""Evaluate the trained BitNet b1.58 model on the held-out no-world-knowledge split."""
...
def main():
    parser = argparse.ArgumentParser(description="Eval BitNet b1.58 on no-world-knowledge data")
